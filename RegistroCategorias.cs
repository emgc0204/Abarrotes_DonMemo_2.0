...
namespace Abarrotes_DonMemo_2._0
{
    public partial class RegistroCategorias : Form
    {
        ...
        private string path = "C:\\Users\\emili\\source\\repos\\Abarrotes_DonMemo_2.0\\project\\Categorias.txt";
        private void fmrRegistroCategorias_Load(object sender, EventArgs e)
        {
            this.lstvListado.Columns.Add("No.", 50, HorizontalAlignment.Center);
            this.lstvListado.Columns.Add("CATEGORIAS", 100, HorizontalAlignment.Center);
